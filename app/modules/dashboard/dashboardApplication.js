...
dashboard.config(["$stateProvider", function ($stateProvider) {
    ...
    $stateProvider.state('app.new', {
        url: '/new',
        templateUrl: 'app/modules/dashboard/views/new.html',
        controller: 'NewPlanController',
        controllerAs: 'vm',
        data: {
            pageTitle: 'Novo plano de aprendizagem'
        }
    });
    ...
    // new plan state
    $stateProvider.state('app.my-content', {
        url: '/my-content',
        templateUrl: 'app/modules/dashboard/views/my-content.html',
        controller: 'MyContentController',
        controllerAs: 'vm',
        data: {
            pageTitle: 'Meus envios'
        }
    });
